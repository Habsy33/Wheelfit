...
const GuideScreen = () => {
  ...
  return (
    <ImageBackground 
      source={require('@/assets/images/wheelfit_background2.png')}
    ...
    >
      ...
      />
        ...
        <View style={{ height: 5, backgroundColor: '#555', borderRadius: 5, overflow: 'hidden' }}>
          <View style={{ width: '33%', height: '100%', backgroundColor: '#FFF' }} />
        </View>
      </View>
      ...
      <View style={{ paddingHorizontal: 20, paddingBottom: 50 }}>
        ...
        <Text style={{ fontSize: 16, color: '#cccccc', textAlign: 'center', marginVertical: 10 }}>
          Choose your own fitness journey with Wheelfit.
        </Text>

        {/* Navigation Buttons */}
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
          <TouchableOpacity
            onPress={() => navigation.replace('SplashScreenTwo')} 
            style={{
              paddingVertical: 12,
